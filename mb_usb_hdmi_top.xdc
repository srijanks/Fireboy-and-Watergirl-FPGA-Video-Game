...
#Audio
set_property PACKAGE_PIN B14 [get_ports {pwm_out[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {pwm_out[0]}]

set_property IOSTANDARD LVCMOS25 [get_ports sw_i]
set_property PACKAGE_PIN G1 [get_ports sw_i]

# Right Channel
set_property PACKAGE_PIN B13 [get_ports {pwm_out[1]}]
